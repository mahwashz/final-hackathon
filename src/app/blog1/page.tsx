...
export default function Blog1() {
  const [comments, setComments] = useState([
    { name: "Zaryab", text: "This is such an inspiring post! Thanks for sharing." },
    { name: "fazal hussain", text: "I loved reading about this trend. Looking forward to more posts like this!" },
  ]);
