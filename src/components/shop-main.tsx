        ...
        <div className="flex gap-5 justify-center mt-10 max-md:mt-5 w-full">
          {Array.from({ length: totalPages }, (_, index) => (
            <div
              ...
              className={`px-6 py-3 rounded-xl h-[60px] w-[60px] flex items-center justify-center cursor-pointer ${
                currentPage === index + 1 ? "bg-amber-100" : "bg-yellow-50"
              } hover:bg-yellow-200 transform transition-all duration-300`}
            >
              {index + 1}
            </div>
          ))}
          <div
            ...
            className={`px-7 py-4 font-light bg-yellow-50 rounded-xl max-md:px-5 cursor-pointer hover:bg-yellow-200 transform transition-all duration-300 ${
